...
namespace Airplane
{
    public class MediumElevators : AirplanePart
    {
        private const float ELEVATOR_MASS = 25.0f;
        private const float ELEVATOR_INFLUENCE = 22.5f;
        ...
        {
            return air.GetString() + "Medium Elevator\n";
        }
